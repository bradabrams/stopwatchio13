 ...
 * on 2013-06-12 at 18:55:23 UTC 
 * Modify at your own risk.
 */

package com.geekyouup.android.ustopwatch.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SendMessage sendMessage(java.lang.String message, java.lang.String sourceDevice) throws java.io.IOException {
    SendMessage result = new SendMessage(message, sourceDevice);
    initialize(result);
    return result;
  }
  ...
  public class SendMessage extends MessageEndpointRequest<Void> {
    ...
    private static final String REST_PATH = "{message}/{sourceDevice}";
     ...
     * @since 1.13
     */
    protected SendMessage(java.lang.String message, java.lang.String sourceDevice) {
      ...
      this.sourceDevice = com.google.api.client.util.Preconditions.checkNotNull(sourceDevice, "Required parameter sourceDevice must be specified.");
    }
    ...
    public SendMessage setSourceDevice(java.lang.String sourceDevice) {
