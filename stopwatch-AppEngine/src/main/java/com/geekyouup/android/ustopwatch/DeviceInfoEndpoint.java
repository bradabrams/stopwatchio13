...
import com.geekyouup.android.ustopwatch.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "geekyouup.com", ownerName = "geekyouup.com", packagePath = "android.ustopwatch"))
